...
from model.networks import Generator, LocalDis, GlobalDis, Generator_primitive
...
class Trainer(nn.Module):
    def __init__(self, config):
        ...
        self.netG = Generator_primitive(self.config['netG'], self.use_cuda, self.device_ids)
    ...
    def forward(self, x, bboxes, masks, masks2, ground_truth, compute_loss_g=False):
        ...
        x1, x2, offset_flow = self.netG(x, masks, masks2)
